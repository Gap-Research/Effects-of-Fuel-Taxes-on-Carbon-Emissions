...
carbontax <- import("data/scm_data/scm_data.csv", dec=".", sep=",")   #Daten für Synth laden
...
#Export store
export(store, file = paste("output/scm_data/placebo_test_store.csv", sep=""), format = "csv")

##PLOT----------------------------------------------------------------------####

data <- import("output/scm_data/placebo_test_store.csv", dec=".", sep=",")
...
# Plot---------------------------------------------------------------------------------#
png(paste("output/scm_plots/placebo_space_permutation_test.png", sep=""))  
