...
#--------------------------------------------------------------------#
#Load weight data
weights.fi <- import("output/scm_data/Finland_tables_country_weights.csv", dec=".", sep=",")  
weights.se <- import("output/scm_data/Sweden_tables_country_weights.csv", dec=".", sep=",") 
weights.no <- import("output/scm_data/Norway_tables_country_weights.csv", dec=".", sep=",") 
...
ggsave("output/scm_plots/pos_confounder_gdp.png", plot = last_plot(), device = "png", dpi = 300, width = 10, height = 6, scale = 2)
...
synth.co2.fi <- import("output/scm_data/Finland_co2_cap_synth.csv", dec=".", sep=",")  
synth.co2.no <- import("output/scm_data/Norway_co2_cap_synth.csv", dec=".", sep=",")  
synth.co2.se <- import("output/scm_data/Sweden_co2_cap_synth.csv", dec=".", sep=",")  
...
# export(plot.co2gdp, file = "output_scm_data/gap_co2_gdp.csv", format = "csv")
#-------------------------------------------------------------------------------#
...
ggsave("output/scm_plots/gap_co2_per_gdp.png", plot = last_plot(), device = "png", dpi = 300, width = 10, height = 6, scale = 2)