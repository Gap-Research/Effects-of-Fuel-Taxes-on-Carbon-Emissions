...
##DATA----------------------------------------------------------------------####
#Load data
reg.data <- import("data/regression_data/fi_reg_file.csv")      #Load prepared data (Finland)
...
star.cutoffs = c(0.05, 0.01),
notes = c("Notes: + p<0.01; * p<0.05"),
           out="output/regression_tables/regression_results_FI.txt"
#          out.header=FALSE
)
