...
##Import data
tax.data <- import("input/regression_data/no_tax_incidence_data.csv", sep=",", dec=".")    #prefix: se, fi
##Prepare data
...
stargazer(reg.tax,      
          title="Tax incidence analysis for Norway",
          ...
          out="output/regression_tables/tax_incidence_results_NO.txt"    #for LaTex-file .tex
)
