...
##Import data
tax.data <- import("input/regression_data/fi_tax_incidence_data.csv", sep=",", dec=".")    #prefix: Finland
...
stargazer(reg.tax,      
          ...
          out="output/regression_tables/tax_incidence_results_FI.txt"    #for LaTex-file .tex
)
